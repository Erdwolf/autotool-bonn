...
grown_left (Branch l k w r)
        | w == (-1) = if (weight l == -1)
                    then (rotation_right (Branch l k 0 ((\(Branch l k w r) -> Branch l k 0 r) r)), False)
...
grown_right (Branch l k w r)
        | w == 1 = if (weight r == 1)
                    then (rotation_left (Branch l k 0 ((\(Branch l k w r) -> Branch l k 0 r) r)), False)
